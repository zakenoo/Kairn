...
public static class ThemePresets
{
    ...
    [
        // Direction artistique par défaut : noir d'encre, texte et accent presque blancs.
        Make("Kairn", true, "#000000", "#0A0A0A", "#151515", "#1E1E1E", "#1F1F1F", "#F2F2F2", "#8C8C8C", "#4D4D4D", "#F2F2F2", "#000000", "#9AD1A8", "#FF6F61", radius: 6),
